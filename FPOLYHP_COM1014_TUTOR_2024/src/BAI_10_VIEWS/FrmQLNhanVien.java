 ...
 */
package BAI_10_VIEWS;

import BAI_10_Services.IQLNhanVienService;
import BAI_10_Services.QLNhanVienService;
...
public class FrmQLNhanVien extends javax.swing.JFrame {
    ...
    public FrmQLNhanVien() {
        ...
        loadTable(_iQLNhanVienService.getLstNhanViens());
    }
    void loadTable(List<NhanVienViewModel> lstData) {//Biến cái loadtable linh động trong bài toán
    if (_iQLNhanVienService.getLstNhanViens().isEmpty()) {
    ...
    for (NhanVienViewModel x : lstData) {//Thay ở đây
      _defaultTableModel.addRow(new Object[]{x.getStt(),x.getTen(),x.getGioiTinh()==1?"Nam":"Nữ"});
    }
